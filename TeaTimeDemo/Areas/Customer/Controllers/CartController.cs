...
namespace TeaTimeDemo.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.Address =
                ShoppingCartVM.OrderHeader.ApplicationUser.Address;
        ...
        public IActionResult SummaryPOST(ShoppingCartVM shoppingCartVM)
        {
            ...
            ApplicationUser applicationUser = _unitOfWork.ApplicationUser.Get
                (u => u.Id == userId);
        ...
        public IActionResult OrderConfirmation(int id)
        {
            OrderHeader orderHeader =
                _unitOfWork.OrderHeader.Get(u => u.Id == id, includeProperties: "ApplicationUser");//送出後等待店家確認訂單
